(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Draggable"] = factory();
  else root["Draggable"] = factory();
})(window, function () {
  return /******/ (function (modules) {
    ...
    /******/ [
        ...
        class Collidable extends _AbstractPlugin2.default {
          ...
          constructor(draggable) {
            ...
            this[onRequestAnimationFrame] =
              this[onRequestAnimationFrame].bind(this);
          }
          ...
          getCollidables() {
            ...
            if (typeof collidables === "string") {
              return Array.prototype.slice.call(
                document.querySelectorAll(collidables)
              );
            } else if (
          ...
          [onRequestAnimationFrame](target) {
            return () => {
              ...
              this.currentlyCollidingElement = (0, _utils.closest)(
                target,
                (element) => collidables.includes(element)
              );
            };
          }
        }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.CollidableOutEvent =
          exports.CollidableInEvent =
          exports.CollidableEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class Sortable extends _Draggable2.default {
          ...
          [onDragOverContainer](event) {
            ...
            const children =
              this.getSortableElementsForContainer(overContainer);
          ...
          [onDragOver](event) {
            ...
            const children =
              this.getDraggableElementsForContainer(overContainer);
            const moves = move({ source, over, overContainer, children });
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.SortableStopEvent =
          exports.SortableSortedEvent =
          exports.SortableSortEvent =
          exports.SortableStartEvent =
          exports.SortableEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class Swappable extends _Draggable2.default {
          ...
          [onDragOver](event) {
            ...
            const swappableSwappedEvent =
              new _SwappableEvent.SwappableSwappedEvent({
                dragEvent: event,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.SwappableStopEvent =
          exports.SwappableSwappedEvent =
          exports.SwappableSwapEvent =
          exports.SwappableStartEvent =
          exports.SwappableEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class Droppable extends _Draggable2.default {
          ...
          [onDragStart](event) {
            ...
            const dropzone = (0, _utils.closest)(
              event.sensorEvent.target,
          ...
          [dropInDropzone](event, dropzone) {
            const droppableDroppedEvent =
              new _DroppableEvent.DroppableDroppedEvent({
                dragEvent: event,
                dropzone,
              });
          ...
          [returnToOriginalDropzone](event) {
            const droppableReturnedEvent =
              new _DroppableEvent.DroppableReturnedEvent({
                dragEvent: event,
          ...
          [getDropzones]() {
            ...
            if (typeof dropzone === "string") {
              ...
              dropzone instanceof NodeList ||
              dropzone instanceof Array
            ) {
              return dropzone;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.DroppableStopEvent =
          exports.DroppableReturnedEvent =
          exports.DroppableDroppedEvent =
          exports.DroppableStartEvent =
          exports.DroppableEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class Draggable {
          ...
          constructor(containers = [document.body], options = {}) {
            ...
            const draggableInitializedEvent =
              new _DraggableEvent.DraggableInitializedEvent({
                draggable: this,
              });
          ...
          destroy() {
            ...
            const draggableDestroyEvent =
              new _DraggableEvent.DraggableDestroyEvent({
                draggable: this,
              });
            ...
            this.removePlugin(
              ...this.plugins.map((plugin) => plugin.constructor)
            );
            this.removeSensor(
              ...this.sensors.map((sensor) => sensor.constructor)
            );
          }
          ...
          [onDragStart](event) {
            ...
            if (
              this.options.handle &&
              target &&
              !(0, _utils.closest)(target, this.options.handle)
            ) {
              sensorEvent.cancel();
              return;
            }
            ...
            this.originalSource = (0, _utils.closest)(
              target,
              this.options.draggable
            );
          ...
          [onDragMove](event) {
            ...
            const withinCorrectContainer = (0, _utils.closest)(
              sensorEvent.target,
              this.containers
            );
            const overContainer =
              sensorEvent.overContainer || withinCorrectContainer;
            ...
            if (isLeavingContainer) {
              const dragOutContainerEvent =
                new _DragEvent.DragOutContainerEvent({
                  source: this.source,
                  originalSource: this.originalSource,
                  sourceContainer: container,
                  sensorEvent,
            ...
            if (isOverContainer) {
              ...
              const dragOverContainerEvent =
                new _DragEvent.DragOverContainerEvent({
                  source: this.source,
                  originalSource: this.originalSource,
                  sourceContainer: container,
                  sensorEvent,
          ...
          [onDragPressure](event) {
            ...
            const source =
              this.source ||
              (0, _utils.closest)(
                sensorEvent.originalEvent.target,
                this.options.draggable
              );
        ...
        class ForceTouchSensor extends _Sensor2.default {
          ...
          constructor(containers = [], options = {}) {
            ...
            this[onMouseForceWillBegin] =
              this[onMouseForceWillBegin].bind(this);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class DragSensor extends _Sensor2.default {
          ...
          [onDragStart](event) {
            ...
            this.currentContainer = (0, _utils.closest)(
              event.target,
              this.containers
            );
          ...
          [onMouseDown](event) {
            ...
            if (
              event.target &&
              (event.target.form || event.target.contenteditable)
            ) {
              return;
            }

            const nativeDraggableElement = (0, _utils.closest)(
              event.target,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class TouchSensor extends _Sensor2.default {
           ...
           */
          [onTouchStart](event) {
            const container = (0, _utils.closest)(
              event.target,
              this.containers
            );
          ...
          [onDistanceChange](event) {
            ...
            const distanceTravelled = (0, _utils.distance)(
              start.pageX,
              start.pageY,
              current.pageX,
              current.pageY
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.DragPressureSensorEvent =
          exports.DragStopSensorEvent =
          exports.DragMoveSensorEvent =
          exports.DragStartSensorEvent =
          exports.SensorEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _requestNextAnimationFrame2 = _interopRequireDefault(
        ...
        class Scrollable extends _AbstractPlugin2.default {
          ...
          getScrollableElement(target) {
            if (this.hasDefinedScrollableElements()) {
              return (
                (0, _utils.closest)(target, this.options.scrollableElements) ||
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.MirrorDestroyEvent =
          exports.MirrorMoveEvent =
          exports.MirrorAttachedEvent =
          exports.MirrorCreatedEvent =
          exports.MirrorCreateEvent =
          exports.MirrorEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.defaultOptions =
          exports.getAppendableContainer =
          exports.onScroll =
          exports.onMirrorMove =
          exports.onMirrorCreated =
          exports.onDragStop =
          exports.onDragMove =
          exports.onDragStart =
            undefined;
        ...
        const onDragMove = (exports.onDragMove = Symbol("onDragMove"));
        const onDragStop = (exports.onDragStop = Symbol("onDragStop"));
        const onMirrorCreated = (exports.onMirrorCreated =
          Symbol("onMirrorCreated"));
        const onMirrorMove = (exports.onMirrorMove = Symbol("onMirrorMove"));
        const onScroll = (exports.onScroll = Symbol("onScroll"));
        const getAppendableContainer = (exports.getAppendableContainer = Symbol(
        ...
        class Mirror extends _AbstractPlugin2.default {
          ...
          [onDragStart](dragEvent) {
            ...
            if (
              isNativeDragEvent(sensorEvent) ||
              mirrorCreateEvent.canceled()
            ) {
              return;
            }
          ...
          [onDragMove](dragEvent) {
            ...
            if (this.options.thresholdX || this.options.thresholdY) {
              ...
              if (
                Math.abs(lastX - sensorEvent.clientX) < this.options.thresholdX
              ) {
                passedThreshX = false;
              } else {
              ...
              if (
                Math.abs(lastY - sensorEvent.clientY) < this.options.thresholdY
              ) {
                passedThreshY = false;
              } else {
          ...
          [onMirrorCreated]({ mirror, source, sensorEvent }) {
            ...
            const setState = (_ref) => {
              let { mirrorOffset, initialX, initialY } = _ref,
                args = _objectWithoutProperties(_ref, [
                  "mirrorOffset",
                  "initialX",
                  "initialY",
                ]);
        ...
        function calculateMirrorOffset(_ref4) {
          ...
          return withPromise((resolve) => {
            ...
            resolve(
              _extends({ sensorEvent, sourceRect, mirrorOffset, options }, args)
            );
          });
        }
        ...
        function resetMirror(_ref5) {
          let { mirror, source, options } = _ref5,
            args = _objectWithoutProperties(_ref5, [
              "mirror",
              "source",
              "options",
            ]);
        ...
        function positionMirror({ withFrame = false, initial = false } = {}) {
          return (_ref8) => {
            let {
              ...
              args = _objectWithoutProperties(_ref8, [
                "mirror",
                "sensorEvent",
                "mirrorOffset",
                "initialY",
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function stripElement(element) {
          const tabIndexElementPosition =
            elementsWithMissingTabIndex.indexOf(element);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.DraggableDestroyEvent =
          exports.DraggableInitializedEvent =
          exports.DraggableEvent =
            undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.DragStoppedEvent =
          exports.DragStopEvent =
          exports.DragPressureEvent =
          exports.DragOutContainerEvent =
          exports.DragOverContainerEvent =
          exports.DragOutEvent =
          exports.DragOverEvent =
          exports.DragMoveEvent =
